...
class DataPipline:
    ...
    def close_spider(self, spider):
        with open('storage/quotes.json', 'w', encoding='utf-8') as f:
            json.dump(self.quotes, f, indent=2, ensure_ascii=False)
        with open('storage/authors.json', 'w', encoding='utf-8') as f:
...
def parse_author(responce):
    content = responce.xpath('/html//div[@class="author-details"]')
